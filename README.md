...
1. __CSV Fields__.  Customize Odoo in order to accommodate the data from the CSV files
2. __Apartment Features__.  In Odoo, the user must be able to see the following:
    1. Must be able to find a person by name or email
    2. Must be able to see a list of all persons
    3. Must be able to see a list of all apartments
    4. Must be able to see which apartment(s) is(are) owned by a given person
    5. Must be able to see the overall balance for a person
    6. Must be able to see the total sum of sq. meters owned by a person
